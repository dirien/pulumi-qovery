...
namespace ediri.Qovery
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("ediri.Qovery.version.txt");
    ...
    internal sealed class QoveryResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public QoveryResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
