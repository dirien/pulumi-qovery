...
namespace ediri.Qovery.Outputs
{
    ...
    [OutputType]
    public sealed class GetHelmValuesOverrideResult
    {
        /// <summary>
        /// Define overrides by selecting a YAML file from a git repository (preferred) or by passing raw YAML files.
        /// </summary>
        public readonly Outputs.GetHelmValuesOverrideFileResult? File;
        ...
        [OutputConstructor]
        private GetHelmValuesOverrideResult(
            Outputs.GetHelmValuesOverrideFileResult? file,
